...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer", "vip", "sf"]
...
# Train video path prefix if any.
_C.DATA.TRAIN_PATH_PREFIX = ""

# Test video path prefix if any.
...
# Used for multi data.
_C.DATA.TRAIN_PATH_TO_FILE_LIST = [
    "train.csv", "flip_train.csv", "reverse_train.csv"
]
_C.DATA.TRAIN_VIDEO_PREFIX_LIST = [
    "labeled_train/Train", "labeled_train/flip_train", "labeled_train/reverse_train"
]
_C.DATA.TRAIN_USED_LABEL = [
...
_C.DATA.TRAIN_BINARY_CLASS = None

# Used for specific classes.
_C.DATA.TRAIN_SPECIFIC_LABEl = None
...
_C.DATA.BALANCE_mode = "downsampling"
