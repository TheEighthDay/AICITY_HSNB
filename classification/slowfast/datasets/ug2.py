...
class Ug2(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, mode, num_retries=10):
        ...
        if self.mode in ['train_label','train_unlabel','val_label','val_dry','val_aridv1.5','pseudo_train_unlabel']:
            ...
            Exception("Split '{}' not supported for Ug2".format(mode))
    ...
    def _construct_loader(self):
        ...
        if self.mode == 'train_label':
            ...
            path_to_file = os.path.join(self.cfg.DATA.PATH_PREFIX, "pseudo_train_unlabel/start_pseudo.csv")
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            if self.cfg.DATA.DECODING_BACKEND == "decord" or self.cfg.DATA.DECODING_BACKEND == "decord_GIC" or self.cfg.DATA.DECODING_BACKEND == "decord_AdaptGIC":
                try:
