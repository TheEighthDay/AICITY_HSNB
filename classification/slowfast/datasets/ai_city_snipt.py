...
class Ai_city_snipt(torch.utils.data.Dataset):
    """
    ...
    def _construct_loader(self):
        ...
        for item in tmp:
            ...
            # 0: start, 1: end
            self._path_to_videos.append([path, start, end])
    ...
    def __getitem__(self, index):
        ...
        path, start, end = self._path_to_videos[index]
        seq = [i for i in range(start, end, 1)]
