...
def load_checkpoint(
    ...
    if convert_from_caffe2:
        ...
        # logger.info("Load the checkpoint from pytorch mode.")
        with g_pathmgr.open(path_to_checkpoint, "rb") as f:
        ...
        if inflation:
            ...
            #     logger.info("Network weights {} should loaded.".format(k))
            ...
            # for k in pre_train_dict_match.keys():
            #     logger.info("Network weights {} has loaded.".format(k))
